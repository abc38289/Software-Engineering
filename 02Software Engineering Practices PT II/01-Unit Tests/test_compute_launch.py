...
def test_days_until_launch_11():
    assert(days_until_launch(9, 20) == 11)

def test_days_until_launch_6():
    assert(days_until_launch(9, 15) == 6)

def test_days_until_launch_11_negative():
    assert(days_until_launch(20, 9) == 0)